...
public class PelicanCrossingPublicTest {
    ...
    @Test
    public void init_entersOperationalCarsGreenNoPed() {
    ...
    @Test
    public void pedWaiting_beforeMinGreen_remembersWaitingButStaysInCarsGreen() {
        PelicanCrossing fsm = new PelicanCrossing();
    ...
    @Test
    public void pedWaiting_duringMinGreen_thenAutoYellow_whenMinGreenEnds() {
        PelicanCrossing fsm = new PelicanCrossing();
        fsm.dispatch(PelicanCrossing.Event.PEDS_WAITING);
        assertEquals(PelicanCrossing.State.OPERATIONAL_CARS_GREEN_PED_WAIT, fsm.getState());
        ...
        // Student solution goes straight to yellow when green min ends in ped-wait path
    ...
    @Test
    public void walkTimesOut_thenFlash() {
        PelicanCrossing fsm = new PelicanCrossing();
        fsm.tick(PelicanCrossing.GREEN_TOUT);
        fsm.dispatch(PelicanCrossing.Event.PEDS_WAITING);
    ...
    @Test
    public void offlineMode_offFromAnyOperationalState_setsSafeAndFlashes() {
        PelicanCrossing fsm = new PelicanCrossing();
